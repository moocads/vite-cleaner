...
export default function FranchisePage() {
  return (
    <PageShell title="Build a Vite garment care business." description="Explore the model, operating support and path to becoming a Vite franchise partner." eyebrow="FRANCHISE" image="/images/service-storefront.png" imageAlt="A Vite garment care storefront">
